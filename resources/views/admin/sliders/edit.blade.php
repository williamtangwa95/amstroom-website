            ...
            <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="margin-bottom: 25px; border-bottom: 1px solid #f1f5f9; padding-bottom: 20px;">
                    ...
                    <div style="display: flex; align-items: center; gap: 15px;">
                        <input type="range" id="overlay_opacity_range" min="0" max="1" step="0.05" value="{{ old('overlay_opacity', $slider->overlay_opacity) }}" style="flex: 1; cursor: pointer; height: 6px; border-radius: 3px; accent-color: var(--royal);" oninput="document.getElementById('overlay_opacity').value = this.value">
                        <input type="number" name="overlay_opacity" id="overlay_opacity" class="form-control" style="width: 100px; text-align: center;" min="0" max="1" step="0.01" value="{{ old('overlay_opacity', $slider->overlay_opacity) }}" oninput="document.getElementById('overlay_opacity_range').value = this.value" required>
                    </div>
                    <small style="color: #64748b; font-size: 12px; margin-top: 5px; display: block;">
