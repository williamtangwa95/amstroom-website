        ...
        <div class="form-card">
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" placeholder="e.g. Laptops, Accessories, Gaming" value="{{ old('name') }}" required autofocus>
                    <small style="color: #777; font-size: 12px; margin-top: 5px; display: block;">
                        The name will be used to generate the slug and identify products in this category.
                    </small>
                </div>

                <div class="form-actions">
                    <button type="submit" class="btn-action btn-primary"><i class="fas fa-save"></i> Save Category</button>
